...
public final class RenderItem extends Render {
	...
	public final void a(RenderEngine var1, ItemStack var2, int var3, int var4) {
		if(var2 != null) {
			int var5;
			int var9;
			if(var2.itemID < 256 && Block.blocksList[var2.itemID].getRenderType() == 0) {
				var9 = var2.itemID;
				var5 = var1.getTexture("/terrain.png");
				...
				if(var2.getItem().getItemStackLimit() >= 0) {
					GL11.glDisable(GL11.GL_LIGHTING);
					if(var2.itemID < 256) {
						var5 = var1.getTexture("/terrain.png");
						GL11.glBindTexture(GL11.GL_TEXTURE_2D, var5);
					} else {
						var5 = var1.getTexture("/gui/items.png");
						GL11.glBindTexture(GL11.GL_TEXTURE_2D, var5);
					}

					int var10000 = var3;
					int var10001 = var4;
					int var10002 = var2.getItem().getItemStackLimit() % 16 << 4;
					int var10003 = var2.getItem().getItemStackLimit() / 16 << 4;
					boolean var6 = true;
					var6 = true;
					var4 = var10003;
					var3 = var10002;
					...
					var10.addVertexWithUV((float)var7, (float)(var9 + 16), 0.0F, (float)var3 * 0.00390625F, (float)(var4 + 16) * 0.00390625F);
					var10.addVertexWithUV((float)(var7 + 16), (float)(var9 + 16), 0.0F, (float)(var3 + 16) * 0.00390625F, (float)(var4 + 16) * 0.00390625F);
					var10.addVertexWithUV((float)(var7 + 16), (float)var9, 0.0F, (float)(var3 + 16) * 0.00390625F, (float)var4 * 0.00390625F);
					var10.addVertexWithUV((float)var7, (float)var9, 0.0F, (float)var3 * 0.00390625F, (float)var4 * 0.00390625F);
					var10.draw();
	...
	public final void a(FontRenderer var1, ItemStack var2, int var3, int var4) {
		if(var2 != null) {
			if(var2.stackSize > 1) {
			...
			if(var2.itemDamage > 0) {
				...
				a(var8, var3 + 2, var4 + 13, 13, 2, 0);
				a(var8, var3 + 2, var4 + 13, 12, 1, var7);
				a(var8, var3 + 2, var4 + 13, var9, 1, var6);
	...
	private static void a(Tessellator var0, int var1, int var2, int var3, int var4, int var5) {
	...
	public final void doRender(Entity var1, float var2, float var3, float var4, float var5, float var6) {
		...
		if(var7.itemID < 256 && Block.blocksList[var7.itemID].getRenderType() == 0) {
			...
			int var14 = var7.getItem().getItemStackLimit();
			if(var7.itemID < 256) {
				this.loadTexture("/terrain.png");
			} else {
